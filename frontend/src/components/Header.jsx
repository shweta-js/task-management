...
import { FaUser, FaSignInAlt, FaSignOutAlt, FaTasks ,faMdDashboard} from 'react-icons/fa';
    ...
    return (
        <nav className="bg-teal-500 p-6">
            <div className="container mx-auto flex items-center justify-between flex-wrap ">
                <Link to='/'>
                    <h2 className="text-white font-bold text-xl mx-4">Task Manager</h2>
                </Link>
                <div className='flex space-x-8'>
                    {user ? (
                        <div className='mx-4 flex'>
                            <button className='text-white text-lg font-bold mr-3'>Welcome, {user.name} |</button>
                            <Link to='/dashboard' className='text-white font-semibold text-lg flex items-center mx-6 hover:opacity-80'>
                                <faMdDashboard className='mr-2' /> Dashboard
                            ...
                            <Link to='/employees' className='text-white font-semibold text-lg flex items-center mr-6 hover:opacity-80'>
                                <IoIosCreate className='mr-2' /> Employees
                            </Link>
                        ...
                        : (
                            <div className='flex space-x-8 mx-4'>
                                ...
                                <Link to='/register' className='text-white font-semibold text-lg flex items-center'>
