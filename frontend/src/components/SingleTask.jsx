...
const SingleTask = ({ task}) => {
    ...
    return (
        <div className="rounded-lg shadow-xl px-12 py-8 flex flex-col mx-20 relative w-2/3 justify-self-center bg-gray-100 singleTask">
            ...
            <div className='flex items-center justify-between'>
                ...
                <Link to={`/tasks/${task._id}`} className='bg-teal-500 text-white rounded-md px-4 py-2 font-bold hover:opacity-80 transition duration-200 sign-me-up'>View More</Link>
            </div>
            {/* <p className="text-lg my-4">{task.assignedTo}</p> */}
            {/* <div className='flex items-center'>
                    <span className='mr-2 font-bold'>assigned to:</span>
                    <p className="text-lg my-4">{task.assignedTo}</p>
                </div> */}
                {/* <div className='flex items-center'>
                    <span className='mr-2 font-bold'>progress</span>
                    <p className="text-lg my-4">{task.progress}</p>
                </div> */}
                {/* <StepProgress>
                    <MyProgress/>
                </StepProgress> */}
